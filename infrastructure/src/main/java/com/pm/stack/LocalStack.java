...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        // 6. Services
        // Auth Service (depends on DB + DB health check)
        FargateService authService = createFargateService(
                "AuthService",
                "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "dmp5eEAjYVE5cFl6RjFyTDchdVc4YlRuRTJoQzBtUjZvUHFHNGtWZFM=")
        );
        ...
        // Analytics Service (depends on MSK)
        ...
        // Patient Service (depends on DB + DB health check + Billing + MSK)
    ...
    private CfnCluster createMskCluster() {
        return CfnCluster.Builder.create(this, "MskCluster")
                ...
                .kafkaVersion("2.8.0")
                .numberOfBrokerNodes(2)  // Changed to 2 to match 2 AZs (must be multiple of AZ count)
                .brokerNodeGroupInfo(CfnCluster.BrokerNodeGroupInfoProperty.builder()
                        .instanceType("kafka.t3.small")  // LocalStack-compatible instance
    ...
    private FargateService createFargateService(String id,
        ...
        ContainerDefinitionOptions.Builder containerOptions = ContainerDefinitionOptions.builder()
                .image(ContainerImage.fromRegistry(imageName + ":latest"))  // Add explicit tag
                ...
                .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                        .logGroup(LogGroup.Builder.create(this, id + "LogGroup")
                                .logGroupName("/ecs/" + imageName + "-" + id.toLowerCase())  // Make unique
                                .removalPolicy(RemovalPolicy.DESTROY)
    ...
    private void createApiGatewayService(){
        FargateTaskDefinition taskDefinition = FargateTaskDefinition.Builder.create(this, "ApiGatewayTaskDefintion")
                .cpu(256)
                .memoryLimitMiB(512)
                .build();
        ...
        ContainerDefinitionOptions containerOptions = ContainerDefinitionOptions.builder()
                ...
                .logging(LogDriver.awsLogs(AwsLogDriverProps.builder()
                        .logGroup(LogGroup.Builder.create(this, "ApiGatewayLogGroup")
                                .logGroupName("/ecs/api-gateway-" + System.currentTimeMillis())  // Timestamp for uniqueness
                                .removalPolicy(RemovalPolicy.DESTROY)
                                .retention(RetentionDays.ONE_DAY)
                                .build())
